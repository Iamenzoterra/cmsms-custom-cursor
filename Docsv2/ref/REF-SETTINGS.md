...
> **See `SOURCE-OF-TRUTH.md` Matrix A for the current, code-verified settings map.**
...
- `SOURCE-OF-TRUTH.md` Matrix A — current Kit-based settings map
- `REF-EFFECTS.md` — Effect physics and algorithms
- `REF-EDITOR.md` — Editor sync protocol

---

*Last Updated: February 17, 2026 | Version: 5.6 | Migrated to Docsv2*
